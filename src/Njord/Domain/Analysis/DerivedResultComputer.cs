...
public sealed class DerivedResultComputer(ResolvedParameterSet parameters)
{
    public DerivedResult Compute(
        ...
        IReadOnlyList<int> horizons)
    {
        ...
        var scalarAmplitude = ComputeScalarAmplitude(consensus, temperature);
        var scalarSunshine = ComputeScalarSunshine(consensus, sunshineDuration, isDay);
    ...
    private static double? ComputeScalarAmplitude(
        ConsensusSnapshot consensus, ParameterDef? tempParam)
    {
    ...
    private static double? ComputeScalarSunshine(
        ConsensusSnapshot consensus, ParameterDef? sunshineDuration, ParameterDef? isDay)
    {
