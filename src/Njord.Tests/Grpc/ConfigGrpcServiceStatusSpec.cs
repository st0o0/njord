...
public sealed class ConfigGrpcServiceStatusSpec : Akka.Hosting.TestKit.TestKit
{
    ...
    private ConfigGrpcService CreateService(NjordOptions? options = null)
    {
        ...
        return new ConfigGrpcService(monitor, persistence, tracker, ActorRegistry, Microsoft.Extensions.Logging.Abstractions.NullLogger<ConfigGrpcService>.Instance);
    }
