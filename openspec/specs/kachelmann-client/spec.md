# kachelmann-client Specification

## Purpose

HTTP client for the Kachelmann weather API: fetches advanced forecasts per location and model, maps responses to domain values, and reports expected failures as typed outcomes without retrying or leaking the API key.
