...
Core weather domain model: the closed, typed v1 parameter set, value-wrapped weather model ids, ordered forecast series tolerant of missing values, and fully identified model forecasts.
