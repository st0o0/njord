# discovery-toggle Specification

## Purpose

Configuration toggle for HA MQTT Discovery: when disabled, discovery config payloads and HA status subscriptions are suppressed while availability and state publishing continue normally.
