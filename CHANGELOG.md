...
* add RequestId correlation to StreamConsumerActor request/response messages ([c73c3ac](https://github.com/st0o0/njord/commit/c73c3acadad52da74c4eb7449f727eb0e27ef271))
* add VERSION build-arg and OCI version label to Dockerfile ([aa62478](https://github.com/st0o0/njord/commit/aa62478e85897340c5083fe9e1ffbec8c30046cb))
...
* resolve race condition in StreamConsumerActor.TryTransition causing CI flake ([5e6de78](https://github.com/st0o0/njord/commit/5e6de78713fff65ccad5cd51216b92038a2024f1))
...
* update CLAUDE.md message pattern and add OpenSpec specs ([980f089](https://github.com/st0o0/njord/commit/980f0891ca3840bd1680854ff927fce8220c211a))


### Refactoring

* extract immutable state records for all persistent actors ([567e8a7](https://github.com/st0o0/njord/commit/567e8a7857e23810e8aed9470056d197e61f0292))
* rename Get* queries to Query* and add response hierarchies ([0b9e15c](https://github.com/st0o0/njord/commit/0b9e15c4afaf25d2ad33a164c446a75fb73691ea))
...
* add NjordMetrics infrastructure with prometheus-net ([13045a1](https://github.com/st0o0/njord/commit/13045a19e9bfc1c4ca67a51475e970480e5fae52))
...
* expose budget usage counters on NjordHealthState ([40013d0](https://github.com/st0o0/njord/commit/40013d091139b0436ba35020a20ee123da5741bc))
...
* instrument actors and wire /metrics endpoint ([ce174df](https://github.com/st0o0/njord/commit/ce174df97a9cad4db7131a97f49c210de8159e18))
* isolate transient failures from MissCount in poll scheduler ([73e0a33](https://github.com/st0o0/njord/commit/73e0a3351d2a359c515a0335663e32d758734273))
...
* heat alert returns Alert.None when severity is none ([6f69ca5](https://github.com/st0o0/njord/commit/6f69ca5138daf916f64110b30af5da711fd1368a))
* heat alert uses max of raw and apparent temp, preserve trigger values ([79e480d](https://github.com/st0o0/njord/commit/79e480d8096f9599f4144ef04fa31eadbf4f0976))
...
* add OpenSpec specs for prometheus-metrics change ([3eecfdd](https://github.com/st0o0/njord/commit/3eecfdd6004a0c218accb392e92c63c2ae24f31e))
...
* bump actions/cache from 4 to 6 ([4b6853f](https://github.com/st0o0/njord/commit/4b6853f8092f435ddbeaac428180ee03c99cd2e1))
...
* bump actions/github-script from 7 to 9 ([e2c2dbf](https://github.com/st0o0/njord/commit/e2c2dbffd9cc06661d78566fcd4cdb046b096beb))
...
* Bump Grpc.Net.Client from 2.80.0 to 2.83.0 ([4942146](https://github.com/st0o0/njord/commit/49421468b4e242fa96a7dd6f157261d0434f2f60))
...
* Bump Microsoft.AspNetCore.Mvc.Testing and 4 others ([9073943](https://github.com/st0o0/njord/commit/90739433476f32f76f15014b3ea4259cb06d77a9))
* Bump Microsoft.Data.Sqlite from 10.0.10 to 10.0.11 ([ec53a98](https://github.com/st0o0/njord/commit/ec53a9830a6a23aed4ca661800089ebdf708c61d))
